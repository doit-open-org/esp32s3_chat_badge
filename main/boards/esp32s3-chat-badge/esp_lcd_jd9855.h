...
} jd9855_lcd_init_cmd_t;

// typedef struct
// {
//     int te_gpio_num;             
//     gpio_int_type_t te_int_type; 
//     uint32_t time_tvdl_us;       
//     uint32_t time_tvdh_us;      
// } jd9855_te_config_t;
 ...
 */
typedef struct {
    const jd9855_lcd_init_cmd_t *init_cmds;    /*!< Pointer to initialization commands array.
    ...
    // jd9855_te_config_t te_cfg;
} jd9855_vendor_config_t;
...
SemaphoreHandle_t esp_lcd_panel_jd9855_get_te_sem(esp_lcd_panel_handle_t panel);
